...
router.get('/unchecked_applications', catchAsyncErrors(async (req, res, next) => {
    ...
    if (userQx.indexOf('7') > -1) {
        ...
        orm.sequelize.query("SELECT a.JZSJ as XMJZSJ,b.*,c.YHM,c.LXDH,c.YHDW,c.SFNBCY FROM s_sj_sqdj a,s_sj_sqxx b,s_sj_yhrzxx c WHERE a.XMDDM=b.XMDDM and a.CPDM=b.CPDM and c.YHRZXX_INDEX=b.YHRZXX_INDEX and ((a.CSR=\'" + payload.jsIndex + "\'and b.BLZT='2') or (a.FSR=\'" + payload.jsIndex + "\'and b.BLZT='3') or (a.SQSHR=\'" + payload.jsIndex + "\'and b.BLZT='4')) group by b.SQXX_INDEX", {
